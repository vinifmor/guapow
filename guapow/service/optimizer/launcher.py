    ...
    def to_ignore(self) -> Set[str]:
        if self._to_ignore is None:
            self._to_ignore = {"wineserver", "services.exe", "winedevice.exe", "plugplay.exe", "svchost.exe",
                               ...
                               "cmd.exe", "conhost.exe", "start.exe", "winemenubuilder", "steam-runtime-l", "proton", "gzip",
                               "steam.exe", "python", "python3", "OriginWebHelper", "Origin.exe",
                               "OriginClientSer", "QtWebEngineProc", "EASteamProxy.ex", "ActivationUI.ex",
                               "EALink.exe", "OriginLegacyCLI", "IGOProxy.exe", "IGOProxy32.exe", "IGOProxy64.exe", "igoproxy64.exe",
                               ...
                               "whql:off", "PnkBstrA.exe", "EABackgroundSer", "EADesktop.exe", "EALocalHostSvc.", "EADestager.exe",
                               "EALaunchHelper", "Link2EA.exe", "ThreadPoolSingl ", "CrBrowserMain"}
